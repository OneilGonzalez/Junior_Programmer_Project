...
struct Cube_tEB0CADF2ED5CCD174FE21940A8708AFFBC74872B  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	float ___cubeScale;
	Color_tD001788D726C3A7F1379BEED0260B9591F440C1F ___startCubeColor;
	Color_tD001788D726C3A7F1379BEED0260B9591F440C1F ___secondCubeColor;
	float ___rotationSpeed;
	float ___colorChangeSpeed;
	bool ___changingToSecond;
};
...
{
	{
		...
		float L_4 = __this->___cubeScale;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_5;
		L_5 = Vector3_op_Multiply_m87BA7C578F96C8E49BB07088DAAC4649F83B0353_inline(L_3, L_4, NULL);
		Transform_set_localScale_mBA79E811BAF6C47B80FF76414C12B47B3CD03633(L_2, L_5, NULL);
		MeshRenderer_t4B7747212F0B88244BB7790C61AE124BFC15BAAE* L_6 = __this->___Renderer;
		...
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_8 = __this->___startCubeColor;
...
{
	{
		...
		bool L_3 = __this->___changingToSecond;
		if (!L_3)
		{
			goto IL_0061;
		}
	...
	{
		MeshRenderer_t4B7747212F0B88244BB7790C61AE124BFC15BAAE* L_4 = __this->___Renderer;
		...
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_9 = __this->___secondCubeColor;
		float L_10 = __this->___colorChangeSpeed;
		float L_11;
		...
		Material_set_color_m5C32DEBB215FF9EE35E7B575297D8C2F29CC2A2D(L_5, L_12, NULL);
		return;
	}

IL_0061:
	{
		MeshRenderer_t4B7747212F0B88244BB7790C61AE124BFC15BAAE* L_13 = __this->___Renderer;
		...
		MeshRenderer_t4B7747212F0B88244BB7790C61AE124BFC15BAAE* L_15 = __this->___Renderer;
		...
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_18 = __this->___startCubeColor;
		float L_19 = __this->___colorChangeSpeed;
		float L_20;
		L_20 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_21;
		L_21 = Color_Lerp_mE79F87889843ECDC188E4CB5B5E1F1B2256E5EBE_inline(L_17, L_18, ((float)il2cpp_codegen_multiply(L_19, L_20)), NULL);
		Material_set_color_m5C32DEBB215FF9EE35E7B575297D8C2F29CC2A2D(L_14, L_21, NULL);
		return;
	}
}
...
{
	{
		__this->___cubeScale = (2.5f);
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_0;
		memset((&L_0), 0, sizeof(L_0));
		Color__ctor_m3786F0D6E510D9CFA544523A955870BD2A514C8C_inline((&L_0), (0.0f), (0.0f), (1.0f), (0.800000012f), NULL);
		__this->___startCubeColor = L_0;
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_1;
		memset((&L_1), 0, sizeof(L_1));
		Color__ctor_m3786F0D6E510D9CFA544523A955870BD2A514C8C_inline((&L_1), (1.0f), (1.0f), (0.0f), (0.800000012f), NULL);
		__this->___secondCubeColor = L_1;
		__this->___rotationSpeed = (15.0f);
		__this->___colorChangeSpeed = (0.5f);
		__this->___changingToSecond = (bool)1;
